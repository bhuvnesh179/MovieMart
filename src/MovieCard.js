                    ...
                    <div className="right">
                        ...
                        <div className="footer">
                            ...
                            <div className="star-dis">
                                ...
                                <img alt="decrease" className="str-btn" src="https://cdn-icons-png.flaticon.com/128/1828/1828906.png" onClick={() => {this.props.decStars(this.props.movies)}}/>

                                <img alt="stars" src="https://cdn-icons-png.flaticon.com/128/1828/1828884.png" className="stars"/>

                                <img alt="increase" className="str-btn" src="https://cdn-icons-png.flaticon.com/128/992/992651.png" onClick={() => {this.props.addStars(this.props.movies)}} />
